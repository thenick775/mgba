...
struct mNPCallbacks {
	...
	void (*rollbackStart)(struct mNPContext*, const uint32_t* cores, uint32_t nCores, void* user);
	void (*rollbackEnd)(struct mNPContext*, const uint32_t* cores, uint32_t nCores, void* user);
};
